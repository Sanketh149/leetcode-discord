...
const App = () => {
  ...
  return (
    <div className="app">
      ...
      <h1 className="app__title">Enter LeetCode ID </h1>
      ...
      {user.length > 0 && <div> The problems below are links :</div>}
      {user.length > 0 ? (
        ...
        <p className="app__message">No User Added</p>
      )}
    </div>
  );
};
